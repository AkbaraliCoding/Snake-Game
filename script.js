let colorOfSnake = document.querySelector('#color')
let colorOffood = document.querySelector('#food')
let colorOfback = document.querySelector('#back')
...
function loop() {
    ...
    // ovqat rangi
    context.fillStyle = colorOffood.value;
    // food.setAttribute('class', 'meal')    
    context.fillRect(food.x, food.y, grid - 1, grid - 1);

    // snake style
    // context.fillStyle = '#E43F5A';
    context.fillStyle = colorOfSnake.value;
